...
// Task 8 : Use in a for...in loop iterate over the properties of the book object
// and log each properties and its value
for (const key in library.books) {
     console.log(library.books[key]);
}

// Task 9 : Use object.keys and object.values methods and log all keys and values 
// of the book object
